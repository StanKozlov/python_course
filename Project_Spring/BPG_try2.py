...
class BreakpointGraph:
   ...
   def draw_BPG(self, first_seq, second_seq, save = False):
        ...
        nx.draw_networkx_nodes(self.BPG, pos, cmap=plt.get_cmap('jet'), node_color = 'black', node_size=50, alpha=0.8)
        nx.draw_networkx_edges(self.BPG, pos, edgelist = first_seq, width = 2, alpha = 0.5, edge_color = 'r', edge_vmax = 100)
        nx.draw_networkx_edges(self.BPG, pos, edgelist = second_seq, width = 2, alpha = 0.5, edge_color = 'b', style = 'dashed')
        if save:
